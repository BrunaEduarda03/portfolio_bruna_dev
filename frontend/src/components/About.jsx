...
const About = () => {
  ...
  const skillCards = [
    { id: 1, title: t('about.frontend'), description: t('about.frontendDesc'), icon: Monitor, span: 'col-span-2' },
    { id: 2, title: t('about.backend'), description: t('about.backendDesc'), icon: Server, span: 'col-span-1' },
    { id: 3, title: t('about.mobile'), description: t('about.mobileDesc'), icon: Smartphone, span: 'col-span-1' },
    { id: 4, title: t('about.databases'), description: t('about.databasesDesc'), icon: Database, span: 'col-span-1' },
    { id: 5, title: t('about.devops'), description: t('about.devopsDesc'), icon: Cloud, span: 'col-span-2' },
    { id: 6, title: t('about.architecture'), description: t('about.architectureDesc'), icon: Layers, span: 'col-span-1' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <span className="text-amber-500 font-mono text-sm">{t('about.sectionNum')}</span>
            <h2 className="text-3xl md:text-4xl font-bold text-zinc-100">{t('about.title')}</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-mono text-xs text-amber-400 tracking-wider uppercase">{t('about.whoAmI')}</span>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-zinc-400">{t('about.availabilityText')}</span>
              </div>
            </div>

            {/* Languages */}
            <div className="mt-6 pt-6 border-t border-zinc-800">
              <span className="font-mono text-xs text-zinc-500 uppercase tracking-wider">{t('about.languages')}</span>
          ...
          <div className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            {educationItems.map((edu, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: 0.1 * (skillCards.length + index) }}
              ...
              >
                ...
                <ul className="space-y-1">
                  {Array.isArray(edu.highlights) && edu.highlights.slice(0, 2).map((h, i) => (
