...
const GeometricShape = ({ className, style, children }) => {
  return (
    ...
    >
      ...
      >
        <div className="relative w-full h-full animate-spin-slow">
          <div className="absolute inset-0 border border-amber-500/30 rotate-45" style={{ clipPath: 'polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)' }} />
          <div className="absolute inset-2 border border-amber-400/20 rotate-[60deg]" style={{ clipPath: 'polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)' }} />
          <div className="absolute inset-4 border border-amber-300/10 rotate-[30deg]" style={{ clipPath: 'polygon(50% 0%, 100% 38%, 82% 100%, 18% 100%, 0% 38%)' }} />
        </div>
      </GeometricShape>
      ...
      >
        <div className="w-full h-full animate-float-fast">
          <div className="absolute inset-0 border border-amber-400/20" style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }} />
        </div>
      </GeometricShape>
      ...
      >
        <div className="w-full h-full animate-spin-very-slow">
          <div className="absolute inset-0 border border-amber-500/15" style={{ clipPath: 'polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%)' }} />
        </div>
      </GeometricShape>
