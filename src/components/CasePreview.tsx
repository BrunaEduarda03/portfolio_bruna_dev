...
import { Smartphone, Cloud, Cpu, Wind, Users } from "lucide-react";
    ...
    <div className={`case-product-visual visual-${study.kind} ${compact ? "is-compact" : ""}`} aria-hidden="true">
      ...
      {study.kind === "mobile" ? (
        ...
        <div className="mock-device">
          <div className="device-top"><small>ECONOWISE / IOT</small><span className="device-people"><Users size={11} />—</span></div>
          <div className="device-dial"><span>—<small>°C</small></span></div>
          <div className="device-flow">
            <span><Smartphone size={14} /></span><i />
            <span><Cloud size={14} /></span><i />
            <span><Cpu size={14} /></span><i />
            <span><Wind size={14} /></span>
          </div>
          <div className="device-flow-labels"><small>App</small><small>Blynk</small><small>ESP32</small><small>A/C</small></div>
        </div>
      ) : (
